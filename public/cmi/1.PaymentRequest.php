...
<body>
	...
	<?php
  	...
  	$orgAmount = "10.25";
  	$orgOkUrl =  "http://localhost/public/Ok-Fail.php";
  	$orgFailUrl = "http://localhost/public/Ok-Fail.php";
  	$shopurl = "http://localhost";
  	$orgTransactionType = "PreAuth";
  	$orgRnd =  microtime();
  	$orgCallbackUrl = "http://localhost/public/callback.php";
  	$orgCurrency = "504";
	?>
	...
	<center>
		...
		<form method="post" action="http://localhost/public/2.SendData.php">
			<table>
				<tr>
