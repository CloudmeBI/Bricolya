                                                    ...
                                                    <tr class="cart-item">
                                                        <td class="product-image" width="25%">
                                                            <a href="{{ route('product', \App\Product::find($id)->slug) }}" target="_blank">
                                                                <img loading="lazy"  src="https://bricolya.com/public/{{\App\Product::find($id)->thumbnail_img}}">
                                                            </a>
                                                        </td>
                                                    ...
                                                    <table class="table-cart">
                                                        <tbody>
                                                            ...
                                                            <tr class="cart-item">
                                                                <td class="product-image" width="25%">
                                                                    <a href="{{ route('product', \App\Product::find($id)->slug) }}" target="_blank">
                                                                        <img loading="lazy"  src="https://bricolya.com/public/{{ \App\Product::find($id)->thumbnail_img }}" datay-y="{{ asset($product->thumbnail_img) }}">
                                                                    </a>
                                                                </td>
                                                                <td class="product-name strong-600">
                                                                    <a href="{{ route('product', \App\Product::find($id)->slug) }}" target="_blank" class="d-block c-base-2">
