...
<!-- bricolya assets / -->
 ...
 <link rel="stylesheet" href="{{ asset('frontend/css/bootstrap.min.css')}}">
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('frontend/vendors/lightbox/css/lightbox.css')}}" media="screen" />
    <link rel="stylesheet" type="text/css" href="{{ asset('frontend/vendors/flexslider/flexslider.css')}}" media="screen" />
...
<!--Nice Scroll-->
<script src="{{ asset('frontend/vendors/nicescroll/jquery.nicescroll.js')}}"></script>

<!--Flickr-->


<!--Lightshot-->
<script src="{{ asset('frontend/vendors/lightbox/js/lightbox.min.js')}}"></script>

<!--Tweets-->
<script src="{{ asset('frontend/vendors/tweet/scripts.js')}}"></script>
<script src="{{ asset('frontend/vendors/tweet/tweetie.min.js')}}"></script>

<!--Counter Up-->
<script src="{{ asset('frontend/vendors/waypoints/waypoints.min.js')}}"></script>
...
<!--Isotope-->
<script src="{{ asset('frontend/vendors/isotope/isotope-custom.js')}}"></script>

<!--FlexSlider-->
<script src="{{ asset('frontend/vendors/flexslider/jquery.flexslider-min.js')}}"></script>

<!--Strella JS-->
<script src="{{ asset('frontend/js/furniture.js')}}"></script>
<!-- bricolya assest\ -->

<!-- whatsapp widget -->

<link rel="stylesheet" href="{{asset('frontend/css/floating-wpp.css')}}">
<script type="text/javascript" src="{{asset('frontend/js/floating-wpp.js')}}"></script>
