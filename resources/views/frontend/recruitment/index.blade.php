        ...
        <div class="container innerHover">
                <div class="row mb30">
                    <div class="img_center col-xs-12 col-md-6">
                      <img src="{{asset('frontend/images/Nos-offres.jpg')}}" class="image" alt="Avatar" style="width:100%">
                      <div class="middle">
                      ...
                      <div class="img_center col-xs-12 col-md-6">
                        <img src="{{asset('frontend/images/Candidature-spontanee.jpg')}}" class="image" alt="Avatar" style="width:100%">
                        <div class="middle">
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-body ">
            <form action="{{url('/send_recruitment')}}" method="POST" enctype="multipart/form-data">
            @csrf
              <div class="row">
