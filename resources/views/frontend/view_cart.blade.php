                    ...
                    <div class="form-default bg-white p-4">
                        ...
                        <div class="row align-items-center pt-4">
                            ...
                            <div class="col-md-6 text-right">
                                @if(Auth::check())
                                    <a href="{{ route('checkout.shipping_info') }}" class="btn btn-styled btn-base-1">Suivant vers l'expédition</a>
                                @else
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="p-3">
                        <form class="form-default" role="form" action="{{ route('cart.login.submit') }}" method="POST">
                            ...
                            <div class="row align-items-center">
                                <div class="col-md-6">
                                    <a href="{{ route('password.request') }}" class="link link-xs link--style-3">mot de passe oublié?</a>
                                </div>
                                <div class="col-md-6 text-right">
                    ...
                    <div class="text-center pt-3">
                        <p class="text-md">
                            Besoin d'un compte?<a href="{{ route('user.registration') }}" class="strong-600">S'inscrire maintenant</a>
                        </p>
                    </div>
                    ...
                    @if (\App\BusinessSetting::where('type', 'guest_checkout_active')->first()->value == 1)
                        ...
                        <div class="text-center">
                            <a href="{{ route('checkout.shipping_info') }}" class="btn btn-styled btn-base-1">Vérification des invités</a>
                        </div>
                    @endif
                </div>
            </div>
