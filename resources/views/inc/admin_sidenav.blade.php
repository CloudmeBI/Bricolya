                ...
                <div class="nano-content">
                    ...
                    <ul id="mainnav-menu" class="list-group">
                        ...
                        @if(Auth::user()->user_type == 'admin')
                            <li class="">
                                <a class="nav-link" href="{{ route('catalogue.client.get')}}">
                                    <i class="fa fa-home"></i>
                                    <span class="menu-title">{{__('Catalogue Client')}}</span>
                                </a>
                            </li>
                        @endif
                        ...
                        @if((Auth::user()->user_type == 'admin'))
                            <li>
                                ...
                                <ul class="collapse">
                                    ...
                                    <li class="{{ areActiveRoutes(['withdraw_requests_all'])}}">
                                        <a class="nav-link" href="{{ route('suppliers.index') }}">{{__('Liste Fournisseurs')}}</a>
                                    </li>
                                </ul>
                            </li>
                        @endif
                        ...
                        <li>
                            ...
                            <ul class="collapse">
                                ...
                                <li class="">
                                            <a class="nav-link" href="{{url('video_page')}}">Video Page</a>
                                        </li>
