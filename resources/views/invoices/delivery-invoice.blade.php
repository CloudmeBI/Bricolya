...
<div>
	...
	<div style="background: #eceff4;padding: 1.5rem;">
		<table>
			<tr>
				...
				<td style="font-size: 2.5rem;" class="text-right strong">Bon De Livraison</td>
			</tr>
		</table>
		<table>
			<tr>
	...
	<div style="padding: 1.5rem;padding-bottom: 0">
		<table>
			...
			@endphp
			<tr><td class="strong small gry-color">Destinataire :</td></tr>
			<tr><td class="strong">{{ $shipping_address->name }}</td></tr>
			<tr><td class="gry-color small">{{ $shipping_address->address }}, {{ $shipping_address->country }}</td></tr>
			<tr><td class="gry-color small">Ville : {{ $shipping_address->city }}</td></tr>
	...
	<table style="padding:0 1.5rem; margin-top:1rem;">
		<td>
			<h3 style="margin-bottom: .8rem">Visa du Client</h3>
			<span>Reçu le : ______________</span><br>
			<span>Signature :</span>
		</td>
		<td>
			<h3 style="margin-bottom: .8rem">Visa du Fournisseur</h3>
			<span>Livré le : ______________</span><br>
		</td>
	</table>
</div>
