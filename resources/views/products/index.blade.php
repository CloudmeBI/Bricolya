...
@if($type != 'Seller')
    <div class="row">
        <div class="col-lg-12 pull-right">
            ...
            <form action="{{route('export-products')}}">
                        ...
                        <td>
                            <a href="{{ route('product', $product->slug) }}" target="_blank" class="media-block">
                                <div class="media-left">
                                    <img loading="lazy"  class="img-md" src="{{ $product->thumbnail_img ? '/'.asset($product->thumbnail_img) : 'https://boschbrandstore.com/wp-content/uploads/2019/01/no-image.png'}}" alt="Image">
                                </div>
