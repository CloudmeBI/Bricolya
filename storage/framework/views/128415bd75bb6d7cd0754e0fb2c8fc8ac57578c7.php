        ...
        <div class="panel">
            ...
            <form class="form-horizontal" action="<?php echo e(route('profile.update', Auth::user()->id)); ?>" method="POST" enctype="multipart/form-data">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label" for="avatar"><?php echo e(__('Avatar')); ?> <small>(120x80)</small></label>
                        <div class="col-sm-10">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/clients/0beb833ad67537cf87e47f391f573b41/web/resources/views/partials/admin_profile.blade.php ENDPATH**/ ?>