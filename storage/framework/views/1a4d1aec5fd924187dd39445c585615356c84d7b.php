		...
		<form class="form form-horizontal mar-top" action="<?php echo e(route('products.update', $product->id)); ?>" method="POST" enctype="multipart/form-data" id="choice_form">
			...
			<div class="panel">
				...
				<div class="panel-body">
					...
					<div class="form-group">
						<label class="col-lg-2 control-label"><?php echo e(__('Référence')); ?></label>
						<div class="col-lg-7">
							<input type="text" class="form-control" name="ref" placeholder="<?php echo e(__('Référence')); ?>" value="<?php echo e($product->ref); ?>" required>
						</div>
					</div>
                    <div class="form-group">
			...
			<div class="panel">
				...
				<div class="panel-body">
						...
						<div class="col-lg-7">
							<select class="form-control color-var-select" name="colors[]" id="colors" multiple>
								<?php $__currentLoopData = \App\Color::orderBy('name', 'asc')->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $color): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
									<option value="<?php echo e($color->code); ?>" <?php if(isset($product->colors) && in_array($color->code, json_decode($product->colors))) echo 'selected'?> ><?php echo e($color->name); ?></option>
								<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
							</select>
						</div>
						<div class="col-lg-2">
							<label class="switch" style="margin-top:5px;">
								<input value="1" type="checkbox" name="colors_active" <?php if(isset($product->colors) && count(json_decode($product->colors)) > 0) echo "checked";?> >
					...
					<div class="customer_choice_options" id="customer_choice_options">
						<?php if(isset($product->choice_options)): ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/368495.cloudwaysapps.com/urvfepvzma/public_html/resources/views/products/edit.blade.php ENDPATH**/ ?>