<?php $__env->startSection('content'); ?>
    ...
    <div class="panel">
        ...
        <div class="panel-heading">
            ...
            <h3 class="panel-title"><?php echo e(__('Seller Withdraw Request')); ?></h3>
            ...
            <table class="table table-striped res-table mar-no" cellspacing="0" width="100%">
                ...
                <thead>
                    ...
                    <tr>
                        ...
                        <th><?php echo e(__('Total Amount to Pay')); ?></th>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <?php if($seller_withdraw_request->status == 1): ?>
                                        ...
                                        <span class="ml-2" style="color:green"><strong><?php echo e(__('Paid')); ?></strong></span>
                                ...
                                <td>
                                    ...
                                    <div class="btn-group dropdown">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-right">
                                            ...
                                            <li><a onclick="show_seller_payment_modal('<?php echo e($seller_withdraw_request->user_id); ?>','<?php echo e($seller_withdraw_request->id); ?>');"><?php echo e(__('Pay Now')); ?></a></li>

                                            <li><a href="<?php echo e(route('sellers.payment_history', encrypt($seller_withdraw_request->user_id))); ?>"><?php echo e(__('Payment History')); ?></a></li>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/clients/0beb833ad67537cf87e47f391f573b41/web/resources/views/seller_withdraw_requests/index.blade.php ENDPATH**/ ?>