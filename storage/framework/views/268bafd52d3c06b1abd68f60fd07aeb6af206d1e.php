...
<div>
	...
	<div style="background: #eceff4;padding: 1.5rem;">
		...
		<table>
			...
			<tr>
				<td class="gry-color small">Courriel: <?php echo e($generalsetting->email); ?></td>
				<td class="text-right small"><span class="gry-color small">?uméro de commande :</span> <span class="strong"><?php echo e($order->code); ?></span></td>
			</tr>
			<tr>
				<td class="gry-color small">Téléphone: <?php echo e($generalsetting->phone); ?></td>
				<td class="text-right small"><span class="gry-color small">Date de commande :</span> <span class=" strong"><?php echo e(date('d-m-Y', $order->date)); ?></span></td>
			</tr>
		</table>
	...
	<div style="padding: 1.5rem;padding-bottom: 0">
		<table>
			...
			<tr><td class="gry-color small">Courriel : <?php echo e($shipping_address->email); ?></td></tr>
			<tr><td class="gry-color small">Téléphone : <?php echo e($shipping_address->phone); ?></td></tr>
		</table>
	</div>
			...
			<?php $__currentLoopData = $order->orderDetails; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $orderDetail): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
				...
				<?php if($orderDetail->product != null): ?>
					<tr class="">
						...
						<td class="gry-color currency"><?php echo e(single_price($orderDetail->product->unit_price)); ?></td>
						<td class="gry-color currency"><?php echo e($orderDetail->product->discount); ?> <?php echo e($orderDetail->product->discount_type == 'amount' ? 'DH' : '%'); ?></td>
						<td class="gry-color"><?php echo e($orderDetail->quantity); ?></td>
						<td class="gry-color currency"><?php echo e($orderDetail->product->tax); ?> <?php echo e($orderDetail->product->tax_type == 'amount' ? 'DH' : '%'); ?></td>
						<td class="text-right currency"><?php echo e(home_discounted_price($orderDetail->product->id,$orderDetail->quantity,null,null)); ?></td>
					</tr>
					<?php
	...
	<div style="padding:0 1.5rem;">
		<table style="width: 40%;margin-left:auto;" class="text-right sm-padding small strong">
			...
			<tr>
				...
				<td class="currency"><?php echo $shipp = in_array(strtolower($shipping_address->city),['casablanca','casa']) ? 0 : 20  ?> MAD</td>
			</tr>
			...
			<tr>
				...
				<td class="currency"><?php echo e($totalTTC + $shipp); ?> MAD/TTC</td>
			</tr>
...
<?php /**PATH /home/clients/0beb833ad67537cf87e47f391f573b41/web/resources/views/invoices/customer_invoice.blade.php ENDPATH**/ ?>