...
<div class="row">
    <div class="col-lg-6">
        <div class="panel">
            <div class="panel-heading bord-btm">
                <h3 class="panel-title"><?php echo e(__('Select Shipping Method')); ?></h3>
            </div>
                ...
                <form action="<?php echo e(route('shipping_configuration.update')); ?>" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="radio mar-btm">
                        ...
                        <label for="product-shipping">
                            <span><?php echo e(__('Product Wise Shipping Cost')); ?></span>
                            <span></span>
                        </label>
                    </div>
                    <div class="radio mar-btm">
                        ...
                        <label for="flat-shipping"><?php echo e(__('Flat Rate Shipping Cost')); ?></label>
                    </div>
                    <div class="radio mar-btm">
                        ...
                        <label for="seller-shipping"><?php echo e(__('Seller Wise Flat Shipping Cost')); ?></label>
                    </div>
                    <div class="">
    ...
    <div class="col-lg-6">
        <div class="panel">
            <div class="panel-heading bord-btm">
                <h3 class="panel-title"><?php echo e(__('Note')); ?></h3>
            </div>
            <div class="panel-body">
                <ul class="list-group">
...
<div class="row">
    <div class="col-lg-6">
        <div class="panel">
            <div class="panel-heading bord-btm">
                <h3 class="panel-title"><?php echo e(__('Flat Rate Cost')); ?></h3>
            </div>
            <form action="<?php echo e(route('shipping_configuration.update')); ?>" method="POST" enctype="multipart/form-data">
            <div class="panel-body">
                <?php echo csrf_field(); ?>
                ...
                <div class="form-group">
                    <div class="col-lg-12">
                        <input class="form-control" type="text" name="flat_rate_shipping_cost" value="<?php echo e(\App\BusinessSetting::where('type', 'flat_rate_shipping_cost')->first()->value); ?>">
                    </div>
                </div>
            </div>
...
<div class="row">
    <div class="col-lg-6">
        <div class="panel">
            <div class="panel-heading bord-btm">
                <h3 class="panel-title"><?php echo e(__('Shipping Cost for Admin Products')); ?></h3>
            </div>
            <form action="<?php echo e(route('shipping_configuration.update')); ?>" method="POST" enctype="multipart/form-data">
            <div class="panel-body">
                <?php echo csrf_field(); ?>
                ...
                <div class="form-group">
                    <div class="col-lg-12">
                        <input class="form-control" type="text" name="shipping_cost_admin" value="<?php echo e(\App\BusinessSetting::where('type', 'shipping_cost_admin')->first()->value); ?>">
                    </div>
                </div>
            </div>
            <div class="panel-footer">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/clients/0beb833ad67537cf87e47f391f573b41/web/resources/views/shipping_configuration/index.blade.php ENDPATH**/ ?>