            ...
            <div class="row">
                <div class="col-sm-6">
                    ...
                    <div class="row m0 contactForm">
                        <form class="row m0" id="contactForm" method="post" name="contact" action="<?php echo e(url('send_contact_mail')); ?>">
                            <?php echo csrf_field(); ?>
                            <div class="row m0">
...
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/clients/0beb833ad67537cf87e47f391f573b41/web/resources/views/frontend/contactus.blade.php ENDPATH**/ ?>