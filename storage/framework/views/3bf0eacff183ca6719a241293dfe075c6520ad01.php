...
<div class="row">
    <h3 class="text-center"><?php echo e(__('Classified Product Activate')); ?></h3>
    <div class="col-lg-4">
        <div class="panel">
            <div class="panel-heading">
                <h3 class="panel-title text-center"><?php echo e(__('Classified Product')); ?></h3>
            </div>
            <div class="panel-body text-center">
                <label class="switch">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/clients/0beb833ad67537cf87e47f391f573b41/web/resources/views/business_settings/activation.blade.php ENDPATH**/ ?>