    ...
    <div class="panel-body">
        ...
        <form method="POST" action="<?php echo e(route('register')); ?>">
            ...
            <div class="checkbox pad-btm text-left">
                ...
                <label for="demo-form-checkbox"><?php echo e(__('I agree with the')); ?> <a href="#" class="btn-link text-bold"><?php echo e(__('Terms and Conditions')); ?></a></label>
            </div>
...
<?php echo $__env->make('layouts.blank', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/clients/0beb833ad67537cf87e47f391f573b41/web/resources/views/auth/register.blade.php ENDPATH**/ ?>