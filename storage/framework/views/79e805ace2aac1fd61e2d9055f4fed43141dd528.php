                                ...
                                <div class="form-box-content p-3">
                                    ...
                                    <?php if($pos_addon != null && $pos_addon->activated == 1): ?>
            							<div class="row mt-2">
            								...
            								<div class="col-md-10">
            									<input type="text" class="form-control mb-3" name="barcode" placeholder="<?php echo e(__('Barcode')); ?>">
            								</div>
            							</div>
                                    <?php endif; ?>
                            ...
                            <div class="form-box bg-white mt-4">
                                ...
                                <div class="form-box-content p-3">
                                    ...
                                    <div class="row" id="quantity">
                                        ...
                                        <div class="col-md-10">
                                            <input type="number" min="0" value="0" step="1" class="form-control mb-3" name="current_stock" placeholder="<?php echo e(__('Quantity')); ?>" required>
                                        </div>
                                    </div>
                                    <div class="row">
...
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/clients/0beb833ad67537cf87e47f391f573b41/web/resources/views/frontend/seller/product_upload.blade.php ENDPATH**/ ?>