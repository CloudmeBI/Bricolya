    ...
    <div class="modal-body">
        <div>
            <table class="table table-responsive">
                <tbody>
                    ...
                    <tr>
                        <?php if($seller_withdraw_request->amount > $seller->admin_to_pay): ?>
                            <td><?php echo e(__('Requested Amount is ')); ?></td>
        ...
        <?php if($seller->admin_to_pay > 0): ?>
            ...
            <div class="form-group">
                <label class="col-sm-3 control-label" for="amount"><?php echo e(__('Requested Amount')); ?></label>
                <div class="col-sm-9">
                    <?php if($seller_withdraw_request->amount > $seller->admin_to_pay): ?>
                        <input type="number" min="0" step="0.01" name="amount" id="amount" value="<?php echo e($seller->admin_to_pay); ?>" class="form-control" required>
                    <?php else: ?>
                        <input type="number" min="0" step="0.01" name="amount" id="amount" value="<?php echo e($seller_withdraw_request->amount); ?>" class="form-control" required>
                    <?php endif; ?>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <select name="payment_option" id="payment_option" class="form-control demo-select2-placeholder" required>
                        ...
                        <?php endif; ?>
                        <?php if($seller->voguepay_status == 1): ?>
...
<?php /**PATH /home/clients/0beb833ad67537cf87e47f391f573b41/web/resources/views/seller_withdraw_requests/payment_modal.blade.php ENDPATH**/ ?>