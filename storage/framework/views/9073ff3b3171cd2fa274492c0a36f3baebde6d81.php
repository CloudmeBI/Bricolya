    ...
    <div class="panel">
        ...
        <form class="form-horizontal" action="<?php echo e(route('flash_deals.update', $flash_deal->id)); ?>" method="POST" enctype="multipart/form-data">
            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                    <label class="col-sm-3 control-label" for="background_color"><?php echo e(__('Background Color')); ?></label>
                    <div class="col-sm-9">
                        <input type="text" placeholder="<?php echo e(__('#0000ff')); ?>" id="background_color" name="background_color" value="<?php echo e($flash_deal->background_color); ?>" class="form-control" required>
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-lg-3 control-label" for="name"><?php echo e(__('Text Color')); ?></label>
                    <div class="col-lg-9">
                        <select name="text_color" id="text_color" class="form-control demo-select2" required>
                            <option value="">Select One</option>
                            <option value="white" <?php if($flash_deal->text_color == 'white'): ?> selected <?php endif; ?>><?php echo e(__('White')); ?></option>
                            <option value="dark" <?php if($flash_deal->text_color == 'dark'): ?> selected <?php endif; ?>><?php echo e(__('Dark')); ?></option>
                        </select>
                    </div>
                </div>
                <div class="form-group">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/clients/0beb833ad67537cf87e47f391f573b41/web/resources/views/flash_deals/edit.blade.php ENDPATH**/ ?>