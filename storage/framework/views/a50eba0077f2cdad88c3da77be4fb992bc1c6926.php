                        ...
                        <form class="" action="<?php echo e(route('products.update', $product->id)); ?>" method="POST" enctype="multipart/form-data" id="choice_form">
                            ...
                            <div class="form-box bg-white mt-4">
                                ...
                                <div class="form-box-content p-3">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-10">
                                            <input type="text" class="form-control mb-3" name="unit" placeholder="Product unit" value="<?php echo e($product->unit); ?>">
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-2">
                                    ...
                                    <?php if($pos_addon != null && $pos_addon->activated == 1): ?>
            							<div class="row mt-2">
            								<label class="col-md-2"><?php echo e(__('Barcode')); ?></label>
            								<div class="col-md-10">
            									<input type="text" class="form-control mb-3" name="barcode" placeholder="<?php echo e(__('Barcode')); ?>" value="<?php echo e($product->barcode); ?>">
            								</div>
            							</div>
                                    <?php endif; ?>
                                    <?php
                                    ...
                                    <?php if($refund_request_addon != null && $refund_request_addon->activated == 1): ?>
            							<div class="row mt-2">
            								<label class="col-md-2"><?php echo e(__('Refundable')); ?></label>
            								<div class="col-md-10">
                            ...
                            <div class="form-box bg-white mt-4">
                                ...
                                <div class="form-box-content p-3">
                                    <div class="row">
                                        ...
                                        <div class="col-md-10">
                                            <input type="text" class="form-control mb-3" name="meta_title" value="<?php echo e($product->meta_title); ?>" placeholder="<?php echo e(__('Meta Title')); ?>">
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-2">
                            ...
                            <div class="form-box bg-white mt-4">
                                ...
                                <div class="form-box-content p-3">
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-md-3">
                                            <label><?php echo e(__('Attributes')); ?></label>
                                        </div>
                                        <div class="col-md-7">
                                            <div class="">
                            ...
                            <div class="form-box bg-white mt-4">
                                ...
                                <div class="form-box-content p-3">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-10">
                                            <input type="number" min="0" step="0.01" class="form-control mb-3" name="purchase_price" placeholder="<?php echo e(__('Purchase Price')); ?>" value="<?php echo e($product->purchase_price); ?>" required>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-2">
                                        ...
                                        <div class="col-8">
                                            <input type="number" min="0" step="0.01" class="form-control mb-3" name="tax" placeholder="<?php echo e(__('Tax')); ?>" value="<?php echo e($product->tax); ?>">
                                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-8">
                                            <input type="number" min="0" step="0.01" class="form-control mb-3" name="discount" placeholder="<?php echo e(__('Discount')); ?>" value="<?php echo e($product->discount); ?>">
                                        </div>
                                        <div class="col-md-2 col-4">
                                            <div class="mb-3">
                                    ...
                                    <div class="row" id="quantity">
                                        <div class="col-md-2">
                                            <label><?php echo e(__('Quantity')); ?> <span class="required-star">*</span></label>
                                        </div>
                                        <div class="col-md-10">
                                            <input type="number" min="0" step="1" class="form-control mb-3" name="current_stock" placeholder="<?php echo e(__('Quantity')); ?>" value="<?php echo e($product->current_stock); ?>">
                                        </div>
                                    </div>
                                    <div class="row">
                                ...
                                <div class="form-box bg-white mt-4">
                                    ...
                                    <div class="form-box-content p-3">
                                        <div class="row">
                                            ...
                                            <div class="col-md-8">
                                                <input type="number" min="0" step="0.01" class="form-control mb-3" name="flat_shipping_cost" value="<?php echo e($product->shipping_cost); ?>" placeholder="<?php echo e(__('Flat Rate Cost')); ?>">
                                            </div>
                                            <div class="col-md-2">
                                                <label class="switch" style="margin-top:5px;">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-8">
                                                <input type="number" min="0" step="0.01" class="form-control mb-3" name="free_shipping_cost" value="0" disabled placeholder="<?php echo e(__('Flat Rate Cost')); ?>">
                                            </div>
                                            <div class="col-md-2">
                                                <label class="switch" style="margin-top:5px;">
...
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/clients/0beb833ad67537cf87e47f391f573b41/web/resources/views/frontend/seller/product_edit.blade.php ENDPATH**/ ?>