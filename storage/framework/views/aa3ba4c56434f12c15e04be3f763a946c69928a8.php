            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <table class="details-table table">
                        ...
                        <tr>
                            <td class="w-50 strong-600"><?php echo e(__('Contact')); ?>:</td>
                                    ...
                                    <?php if($refund_request_addon != null && $refund_request_addon->activated == 1): ?>
                                        <td>
                                            <?php if($orderDetail->product != null && $orderDetail->product->refundable != 0 && $orderDetail->refund_request == null): ?>
                                                <button type="submit" class="btn btn-styled btn-sm btn-base-1" onclick="send_refund_request('<?php echo e($orderDetail->id); ?>')"><?php echo e(__('Send')); ?></button>
                                            ...
                                            <?php elseif($orderDetail->refund_request != null && $orderDetail->refund_request->refund_status == 1): ?>
                                                <span class="strong-600"><?php echo e(__('Paid')); ?></span>
                                            <?php endif; ?>
                                        </td>
                                    <?php endif; ?>
                                </tr>
...
<?php /**PATH /home/clients/0beb833ad67537cf87e47f391f573b41/web/resources/views/frontend/partials/order_details_seller.blade.php ENDPATH**/ ?>