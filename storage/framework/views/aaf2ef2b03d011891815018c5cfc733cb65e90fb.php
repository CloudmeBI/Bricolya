        ...
        <div class="panel">
            ...
            <form class="form-horizontal" action="<?php echo e(route('languages.key_value_store')); ?>" method="POST">
                ...
                <div class="panel-footer text-right">
                    <button type="button" class="btn btn-purple" onclick="copyTranslation()"><?php echo e(__('Copy Translations')); ?></button>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/clients/0beb833ad67537cf87e47f391f573b41/web/resources/views/business_settings/languages/language_view.blade.php ENDPATH**/ ?>