    ...
    <div class="bord-btm mar-btm">
        <div class="row ">
            ...
            <div class="col-sm-6 text-right">
                <a href="<?php echo e(route('addons.create')); ?>" class="btn btn-rounded btn-info"><?php echo e(__('Install New Addon')); ?></a>
            </div>
        </div>
    </div>
            ...
            <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="panel addon-panel">
                            <div class="panel-header">
                                <img class="img-responsive" src="<?php echo e(asset($addon->image)); ?>" alt="Image">
                                                ...
                                                <div class="panel clearfix pad-no mar-no">
                                                    ...
                                                    <div class="blog-content text-center">
                                                        <div class="pad-lft">
                                                            ...
                                                            <div class="blog-body">
                                                                <p><small>Version: </small><?php echo e($addon->version); ?></p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                ...
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                    <div class="col-lg-4 col-md-6 col-lg-offset-4">
                        <div class="panel addon-panel">
                            <div class="panel-header">
                                <img class="img-responsive" src="<?php echo e(asset('img/nothing-found.jpg')); ?>" alt="Image">
                            </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/clients/0beb833ad67537cf87e47f391f573b41/web/resources/views/addons/index.blade.php ENDPATH**/ ?>