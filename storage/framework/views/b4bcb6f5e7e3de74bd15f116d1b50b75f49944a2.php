                                                ...
                                                <?php if(\App\BusinessSetting::where('type', 'paypal_payment')->first()->value == 1): ?>
                                                    <div class="col-6">
                                                        <label class="payment_option mb-4" data-toggle="tooltip" data-title="Paypal">
                                                            ...
                                                            <span>
                                                                <img loading="lazy"  src="https://bricolia.dev.cloudme.cloud/public/frontend/images/icons/cards/paypal.png" class="img-fluid">
                                                            </span>
                                                        </label>
                                                    </div>
                                                <?php endif; ?>
                                                ...
                                                <?php if(\App\BusinessSetting::where('type', 'sslcommerz_payment')->first()->value == 1): ?>
                                                    <div class="col-6">
                                                        <label class="payment_option mb-4" data-toggle="tooltip" data-title="sslcommerz">
                                                            ...
                                                            <span>
                                                                <img loading="lazy"  src="https://bricolia.dev.cloudme.cloud/public/frontend/images/icons/cards/sslcommerz.png" class="img-fluid">
                                                            </span>
                                                        </label>
                                                    </div>
                                                <?php endif; ?>
                                                <?php if(\App\BusinessSetting::where('type', 'instamojo_payment')->first()->value == 1): ?>
                                                    <div class="col-6">
                                                        <label class="payment_option mb-4" data-toggle="tooltip" data-title="Instamojo">
                                                            ...
                                                            <span>
                                                                <img loading="lazy"  src="https://bricolia.dev.cloudme.cloud/public/frontend/images/icons/cards/instamojo.png" class="img-fluid">
                                                            </span>
                                                        </label>
                                                    </div>
                                                <?php endif; ?>
                                                <?php if(\App\BusinessSetting::where('type', 'razorpay')->first()->value == 1): ?>
                                                    <div class="col-6">
                                                        <label class="payment_option mb-4" data-toggle="tooltip" data-title="Razorpay">
                                                            ...
                                                            <span>
                                                                <img loading="lazy"  src="https://bricolia.dev.cloudme.cloud/public/frontend/images/icons/cards/rozarpay.png" class="img-fluid">
                                                            </span>
                                                        </label>
                                                    </div>
                                                <?php endif; ?>
                                                <?php if(\App\BusinessSetting::where('type', 'paystack')->first()->value == 1): ?>
                                                    <div class="col-6">
                                                        <label class="payment_option mb-4" data-toggle="tooltip" data-title="Paystack">
                                                            ...
                                                            <span>
                                                                <img loading="lazy"  src="https://bricolia.dev.cloudme.cloud/public/frontend/images/icons/cards/paystack.png" class="img-fluid">
                                                            </span>
                                                        </label>
                                                    </div>
                                                <?php endif; ?>
                                                <?php if(\App\BusinessSetting::where('type', 'voguepay')->first()->value == 1): ?>
                                                    <div class="col-6">
                                                        <label class="payment_option mb-4" data-toggle="tooltip" data-title="VoguePay">
                                                            ...
                                                            <span>
                                                                <img loading="lazy"  src="https://bricolia.dev.cloudme.cloud/public/frontend/images/icons/cards/vogue.png" class="img-fluid">
                                                            </span>
                                                        </label>
                                                    </div>
                                                <?php endif; ?>
                                                <?php if(\App\Addon::where('unique_identifier', 'paytm')->first() != null && \App\Addon::where('unique_identifier', 'paytm')->first()->activated): ?>
                                                    <div class="col-6">
                                                        <label class="payment_option mb-4" data-toggle="tooltip" data-title="Paytm">
                                                            ...
                                                            <span>
                                                                <img loading="lazy" src="https://bricolia.dev.cloudme.cloud/public/frontend/images/icons/cards/paytm.jpg" class="img-fluid">
                                                            </span>
                                                        </label>
                                                    </div>
                                                <?php endif; ?>
                                                    ...
                                                    <?php if($digital != 1): ?>
                                                        <div class="col-6">
                                                            <label class="payment_option mb-4" data-toggle="tooltip" data-title="Cash on Delivery">
                                                                ...
                                                                <span>
                                                                    <img loading="lazy"  src="https://bricolia.dev.cloudme.cloud/public/frontend/images/icons/cards/cod.png" class="img-fluid">
                                                                </span>
                                                            </label>
                                                        </div>
                                                    <?php endif; ?>
...
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/clients/0beb833ad67537cf87e47f391f573b41/web/resources/views/frontend/payment_select.blade.php ENDPATH**/ ?>