<?php $__env->startSection('content'); ?>
            ...
            <div class="row cols-delimited justify-content-center">
                <div class="col">
                    <div class="icon-block icon-block--style-1-v5 text-center active">
                        ...
                        <div class="block-content d-none d-md-block">
                            <h3 class="heading heading-sm strong-300 c-gray-light text-capitalize">1. Mon panier</h3>
                        </div>
                    </div>
                </div>
                ...
                <div class="col">
                    <div class="icon-block icon-block--style-1-v5 text-center">
                        ...
                        <div class="block-content d-none d-md-block">
                            <h3 class="heading heading-sm strong-300 c-gray-light text-capitalize">2. Informations d'expédition</h3>
                        </div>
                    </div>
                </div>
                ...
                <div class="col">
                    <div class="icon-block icon-block--style-1-v5 text-center">
                        ...
                        <div class="block-content d-none d-md-block">
                            <h3 class="heading heading-sm strong-300 c-gray-light text-capitalize">3. Informations de livraison</h3>
                        </div>
                    </div>
                </div>
                ...
                <div class="col">
                    <div class="icon-block icon-block--style-1-v5 text-center">
                        ...
                        <div class="block-content d-none d-md-block">
                            <h3 class="heading heading-sm strong-300 c-gray-light text-capitalize">4. Paiement</h3>
                        </div>
                    </div>
                </div>
    ...
    <section class="py-4 gry-bg" id="cart-summary">
        <div class="container">
                ...
                <div class="col-md-8">
                    ...
                    <div class="form-default bg-white p-4">
                                        ...
                                        <?php $__currentLoopData = Session::get('cart'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $cartItem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            <tr class="cart-item">
                                                ...
                                                <td class="product-total">
                                                    <span><?php echo e($product->unit_price *$cartItem['quantity']); ?> HT</span>
                                                </td>
                        ...
                        <div class="row align-items-center pt-4">
                            <div class="col-md-6">
                                <a href="<?php echo e(route('all_products')); ?>" class="link link--style-3">
                            ...
                            <div class="col-md-6 text-right">
                                <?php if(Auth::check()): ?>
                                    <a href="<?php echo e(route('checkout.shipping_info')); ?>" class="btn btn-styled btn-base-1">Suivant vers l'expédition</a>
                                <?php else: ?>
                                    <button class="btn btn-styled btn-base-1" onclick="showCheckoutModal()">Suivant vers l'expédition</button>
                                <?php endif; ?>
                            </div>
                        </div>
                    </div>
            ...
            <?php else: ?>
                <div class="dc-header">
                    <h3 class="heading heading-6 strong-700">Votre panier est vide</h3>
                </div>
            <?php endif; ?>
        </div>
    </section>
        ...
        <div class="modal-dialog modal-dialog-zoom" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h6 class="modal-title" id="exampleModalLabel">s'identifier</h6>
                ...
                <div class="modal-body">
                    <div class="p-3">
                        <form class="form-default" role="form" action="<?php echo e(route('cart.login.submit')); ?>" method="POST">
                            ...
                            <div class="row align-items-center">
                                <div class="col-md-6">
                                    <a href="<?php echo e(route('password.request')); ?>" class="link link-xs link--style-3">mot de passe oublié?</a>
                                </div>
                                <div class="col-md-6 text-right">
                                    <button type="submit" class="btn btn-styled btn-base-1 px-4">se connecter</button>
                                </div>
                            </div>
                        </form>
                    ...
                    <div class="text-center pt-3">
                        <p class="text-md">
                            Besoin d'un compte?<a href="<?php echo e(route('user.registration')); ?>" class="strong-600">S'inscrire maintenant</a>
                        </p>
                    </div>
                        ...
                        <div class="p-3 pb-0">
                            <?php if(\App\BusinessSetting::where('type', 'facebook_login')->first()->value == 1): ?>
                                <a href="<?php echo e(route('social.login', ['provider' => 'facebook'])); ?>" class="btn btn-styled btn-block btn-facebook btn-icon--2 btn-icon-left px-4 mb-3">
                                    <i class="icon fa fa-facebook"></i> Se connecter avec Facebook
                                </a>
                            <?php endif; ?>
                            <?php if(\App\BusinessSetting::where('type', 'google_login')->first()->value == 1): ?>
                                <a href="<?php echo e(route('social.login', ['provider' => 'google'])); ?>" class="btn btn-styled btn-block btn-google btn-icon--2 btn-icon-left px-4 mb-3">
                                    <i class="icon fa fa-google"></i> Se connecter avec Google
                                </a>
                            <?php endif; ?>
                            ...
                            <a href="<?php echo e(route('social.login', ['provider' => 'twitter'])); ?>" class="btn btn-styled btn-block btn-twitter btn-icon--2 btn-icon-left px-4 mb-3">
                                <i class="icon fa fa-twitter"></i> Se connecter avec Twitter
                            </a>
                            <?php endif; ?>
                        </div>
                    <?php endif; ?>
                    <?php if(\App\BusinessSetting::where('type', 'guest_checkout_active')->first()->value == 1): ?>
                        ...
                        <div class="text-center">
                            <a href="<?php echo e(route('checkout.shipping_info')); ?>" class="btn btn-styled btn-base-1">Vérification des invités</a>
                        </div>
                    <?php endif; ?>
                </div>
            </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/368495.cloudwaysapps.com/urvfepvzma/public_html/resources/views/frontend/view_cart.blade.php ENDPATH**/ ?>