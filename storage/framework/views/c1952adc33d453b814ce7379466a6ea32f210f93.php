                    ...
                    <div class="media bord-top pad-top">
                        <a class="media-left" href="#">
                            <?php if($ticketreply->user->avatar_original === null): ?>
                                <img class="img-circle img-sm" src="<?php echo e(asset($ticketreply->user->avatar_original)); ?>">
                            <?php else: ?>
                                <img class="img-circle img-sm" src="<?php echo e(asset('frontend/images/user.png')); ?>">
                            <?php endif; ?>
                        </a>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/clients/0beb833ad67537cf87e47f391f573b41/web/resources/views/support_tickets/show.blade.php ENDPATH**/ ?>