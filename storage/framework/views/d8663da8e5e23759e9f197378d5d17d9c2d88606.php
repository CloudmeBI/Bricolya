            ...
            <div class="row col-sm-6">
                  <div class="row m0 titleRow mb30">
                      <div class="fleft titlePart">
                        ...
                        <div class="row m0 titleRow mb30">
                          ...
                          <a href="<?php echo e(route('user.registration')); ?>" class="btn btn-yellow btn-sm">Créer un compte</a>
                                ...
                                <form class="form-default" role="form" action="<?php echo e(route('register')); ?>" method="POST">
                                  ...
                                  <div class="modal-body">
                                    <div class="row">
                                        ...
                                        <input type="text" class="form-control<?php echo e($errors->has('name') ? ' is-invalid' : ''); ?>" required value="<?php echo e(old('name')); ?>" placeholder="Nom" name="name">
										</div>
										<div class="form-group col-xs-12 col-md-6">
                ...
                <div class="row col-sm-6 my15">
                    ...
                    <div class="row m0 contactForm">
                        <form class="row m0" id="contactForm" method="POST" name="contact" action="<?php echo e(route('login')); ?>">
                            <?php echo csrf_field(); ?>
                            <div class="row m0">
                              <label for="name">E-mail:</label>
                              <input type="email" required class="form-control <?php echo e($errors->has('email') ? ' is-invalid' : ''); ?>" value="<?php echo e(old('email')); ?>" placeholder="" name="email">

                            </div>
                            <div class="row m0">
                                <label for="subject">Mot de passe:</label>
                                <input type="password" required class="form-control <?php echo e($errors->has('password') ? ' is-invalid' : ''); ?>" placeholder="" name="password" id="password">
                            </div>
                            <div class="row m0">
                                <label for="subject">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/368495.cloudwaysapps.com/urvfepvzma/public_html/resources/views/frontend/user_login.blade.php ENDPATH**/ ?>