                ...
                <div class="panel-body">
                    <ul class="list-group">
                        <li class="list-group-item">
                            1. <?php echo e($business_settings->value); ?>% of seller product price will be deducted from seller earnings.
                        </li>
                        <li class="list-group-item">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/clients/0beb833ad67537cf87e47f391f573b41/web/resources/views/business_settings/vendor_commission.blade.php ENDPATH**/ ?>