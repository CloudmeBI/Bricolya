                ...
                <div class="nano-content">
                    ...
                    <ul id="mainnav-menu" class="list-group">
                        ...
                        <?php if(Auth::user()->user_type == 'admin'): ?>
                            <li class="">
                                <a class="nav-link" href="<?php echo e(route('catalogue.client.get')); ?>">
                                    <i class="fa fa-home"></i>
                                    <span class="menu-title"><?php echo e(__('Catalogue Client')); ?></span>
                                </a>
                            </li>
                        <?php endif; ?>
                        ...
                        <?php if((Auth::user()->user_type == 'admin')): ?>
                            <li>
                                <a href="#">
                                    <i class="fa fa-user-plus"></i>
                                    <span class="menu-title"><?php echo e(__('Fournisseurs')); ?></span>
                                    <i class="arrow"></i>
                                </a>
                                ...
                                <ul class="collapse">
                                    ...
                                    <li class="<?php echo e(areActiveRoutes(['withdraw_requests_all'])); ?>">
                                        <a class="nav-link" href="<?php echo e(route('suppliers.index')); ?>"><?php echo e(__('Liste Fournisseurs')); ?></a>
                                    </li>
                                </ul>
                            </li>
                        <?php endif; ?>
                        ...
                        <li>
                            ...
                            <ul class="collapse">
                                ...
                                <li class="">
                                            <a class="nav-link" href="<?php echo e(url('video_page')); ?>">Video Page</a>
                                        </li>
...
<?php /**PATH /home/368495.cloudwaysapps.com/urvfepvzma/public_html/resources/views/inc/admin_sidenav.blade.php ENDPATH**/ ?>