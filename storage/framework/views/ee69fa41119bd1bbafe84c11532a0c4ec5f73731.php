            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        ...
                        <div class="row">
                            <div class="col-sm-10">
                                <label class="control-label"><?php echo e(__('Addon Manager')); ?></label>
                            </div>
                            <div class="col-sm-2">
                                <label class="switch">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/clients/0beb833ad67537cf87e47f391f573b41/web/resources/views/roles/create.blade.php ENDPATH**/ ?>