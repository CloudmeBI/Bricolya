...
<section class="row">
    ...
    <div class="container contentRowPad">
        <div class="row col-sm-6">
              ...
              <a href="<?php echo e(route('supplier.register.get')); ?>" type="button" class="btn btn-dark btn-sm" >Créer un compte</a>
            ...
            <div class="row col-sm-6 my15">
                ...
                <div class="row m0">
                    <form class="row m0"  method="post" name="contact" action="<?php echo e(route('supplier.login')); ?>">
                        <?php echo csrf_field(); ?>
                        <div class="row m0">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/clients/0beb833ad67537cf87e47f391f573b41/web/resources/views/frontend/supplier_login.blade.php ENDPATH**/ ?>